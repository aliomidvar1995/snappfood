<template>
    <div dir="rtl" class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
        <teleport to="title">ورود</teleport>
        <div class="sm:mx-auto sm:w-full sm:max-w-sm">
            <h2 class="mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">ورود</h2>
        </div>
        ...
        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            <form @submit="login" class="space-y-6">
                ...
                <div>
                    <button type="submit"
                        class="flex w-full justify-center rounded-md bg-indigo-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">ورود</button>
                </div>
            </form>

            <p class="mt-10 text-center text-sm text-gray-500">
                ثبت نام نکرده اید؟
                <router-link :to="{name: 'Register'}" class="font-semibold leading-6 text-indigo-600 hover:text-indigo-500 cursor-pointer">ثبت نام</router-link>
            </p>
        </div>
    </div>
</template>
