...
@section('title')
    <title>اسنپ فود | صفحه ورود</title>
@endsection
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="d-flex justify-content-center mb-2">
                <svg class="snapp" xmlns="http://www.w3.org/2000/svg" width="136.08" height="69.54" viewBox="0 0 56 28"
                fill="none">
                    <path
                    ...
                    <path
                        ...
                        fill="#FF00A6"></path>
                    <path d="M50.4562 0.535313H50.658V0.407269H50.0951V0.535313H50.297V1.0703H50.4562V0.535313Z"
                        fill="#FF00A6"></path>
                    <path
            ...
            <div class="card w-50 m-auto shadow">
                <div class="card-header text-center fw-bold fs-4">{{ __('ورود') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('login.post') }}">
                        ...
                        <div class="form-group pb-2">
                            <label class="pb-2" for="email">{{ __('ایمیل') }}</label>
                        ...
                        <div class="form-group pb-2">
                            <label class="pb-2" for="password">{{ __('رمز عبور') }}</label>
