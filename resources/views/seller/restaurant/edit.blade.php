    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card w-50 m-auto shadow">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('seller.restaurants.update', ['restaurant' => $restaurant]) }}" enctype="multipart/form-data">
                        @csrf
                        @method('put')
                        ...
                        <div class="form-group mb-2">
                            ...
                            <input id="days" type="text" class="form-control @error('days') is-invalid @enderror" name="days" value="{{ $restaurant->days }}">
                            @error('days')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group mb-2">
                            ...
                            <input id="start" type="time" class="form-control @error('start') is-invalid @enderror" name="start" value="{{ $restaurant->start }}">
                            @error('start')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group mb-2">
                            ...
                            <input id="end" type="time" class="form-control @error('end') is-invalid @enderror" name="end" value="{{ $restaurant->end }}">
                            @error('end')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
